<template>
  <div>
    <h1 class="mb-3 text-90 font-normal text-2xl capitalize">{{ resource }}</h1>
    <div class="flex" style="">
      ...
      <div class="w-full flex items-center mb-6">
        ...
        <div class="flex-no-shrink ml-auto">
          <router-link
            :to="
              `/resources/${resource}/new?viaResource=&viaResourceId=&viaRelationship=`
            "
            class="capitalize btn btn-default btn-primary"
            dusk="create-button"
          >
            Create {{ resource }}
          </router-link>
