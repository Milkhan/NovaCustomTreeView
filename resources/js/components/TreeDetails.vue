<template>
    <div class="ml-6 w-full" v-if="node">
        <div class="flex items-center mb-3">
            <h1 class="flex-no-shrink text-90 font-normal text-2xl">Details - {{node.text.length<14 ? node.text : node.text.substring(0,13) + '..'}}</h1>
        ...
        <div class="card mb-6 py-3 px-6">
            ...
            <div class="flex border-b border-40">
                <div class="w-1/4 py-4">
                    <h4 class="font-normal text-80">Score</h4>
                </div>
                <div class="w-3/4 py-4 break-words">
