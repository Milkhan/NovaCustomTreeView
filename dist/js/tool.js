...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api__ = __webpack_require__(25);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getData: function getData() {
      __WEBPACK_IMPORTED_MODULE_2__api__["a" /* default */].getResource().then(function (result) {
    ...
    updateNode: function updateNode(node) {
      ...
      return Nova.request().post("/nova-api/" + this.resource + "/" + node.id + "?editing=true&editMode=update", this.formData(node, fields, "PUT")).then(function (res) {
    ...
    fetchData: function fetchData() {
      ...
      this.loading = true;
      __WEBPACK_IMPORTED_MODULE_2__api__["a" /* default */].getResource().then(function (res) {
        _this4.currentNode = null;
        console.log("res.data", res.data);
        _this4.parseResources(res.data);
    ...
    mergeResponse: function mergeResponse(res) {
      if (res.id && res.resource) {
        var _res$resource = res.resource,
            ...
            title = _res$resource.title,
            order = _res$resource.order,
            is_active = _res$resource.is_active;

        var node = this.parents[id];
        var parent = this.parents[parent_id];
        ...
        [
          _c("div", { staticClass: "flex items-center mb-3" }, [
            _c(
              ...
              [_vm._v("Details - " + _vm._s(_vm.node.text))]
            ),
            _vm._v(" "),
...
/* harmony default export */ __webpack_exports__["a"] = ({
    getResource: function getResource() {
        return window.axios.post('/nova-vendor/tree-view/get-resource').then(function (response) {
