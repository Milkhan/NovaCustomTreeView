...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TreeContainer__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TreeContainer___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__TreeContainer__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        TreeContainer: __WEBPACK_IMPORTED_MODULE_0__TreeContainer___default.a
    },
...
Component.options.__file = "resources/js/components/TreeContainer.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-25854ca8", Component.options)
  } else {
    hotAPI.reload("data-v-25854ca8", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Tree__ = __webpack_require__(7);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    Tree: __WEBPACK_IMPORTED_MODULE_0__Tree___default.a
  },
  methods: {
...
var update = __webpack_require__(11)("2f4ad290", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-138228ee\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Tree.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-138228ee\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Tree.vue");
...
// module
exports.push([module.i, "\nbutton:focus {\n  outline: none;\n}\n.tree-default .tree-themeicon-custom {\n  border: none;\n  border-radius: 100px;\n  -webkit-box-shadow: 0 0 0 4px white inset;\n          box-shadow: 0 0 0 4px white inset;\n}\n.tree-default .tree-themeicon-custom.enabled {\n    background: #252d37;\n}\n.tree-default .tree-themeicon-custom.disabled {\n    background: #7b8ca3;\n}\n.tree-default .tree-themeicon-custom.parentDisabled {\n    background: orange;\n}\n", ""]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TreeDetails__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TreeDetails___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__TreeDetails__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_jstree__ = __webpack_require__(17);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    parseResources: function parseResources(rows) {
      ...
      rows.forEach(function (row) {
        // console.log(row)
        var leaf = map[row.id.value] = {
          id: row.id.value,
          text: _this.attrValue(row, "name"),
          is_active: _this.attrValue(row, "is_active"),
          icon: _this.isActiveIcon(true, true),
          order: _this.attrValue(row, "order"),
          score: _this.attrValue(row, "score"),
          parentText: _this.attrValue(row, "parent"),
          parentId: _this.attrValue(row, "parent", "belongsToId"),
          selected: false,
          children: [],
          opened: true
        };
      ...
      rows.forEach(function (row) {
        ...
        if (leaf.parentId) {
          if (map[leaf.parentId]) {
            var parent = map[leaf.parentId];
            if (!parent.children) parent.children = [leaf];else parent.children.push(leaf);
            _this.order(parent.children);
          }
        } else {
      ...
      console.log("tree", typeof tree === "undefined" ? "undefined" : _typeof(tree), tree);
      ...
      this.parents = map;
      this.tree = tree;
      Object.values(tree).forEach(function (root) {
        return _this.setIconState(root.children, root.is_active);
      });
    },
    attrValue: function attrValue(row, attr) {
      var prop = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "value";

      var field = row.fields.find(function (f) {
    ...
    dragEnded: function dragEnded(node, item, draggedItem, e) {
      // console.log( 'node')
      // console.log( node)
      // console.log( item)
    ...
    formData: function formData(node, fields, method) {
      var formData = new FormData();
      var nodeFields = _extends({
        order: node.order,
        title: node.text
      }, fields);
      for (var attr in nodeFields) {
    ...
    updateNode: function updateNode(node) {
      ...
      return Nova.request().post("/nova-api/" + this.resource + "/" + node.id + "?viaResource=&viaResourceId=&viaRelationship=&editing=true&editMode=update", this.formData(1, newObj, "PUT")).then(function (res) {
        _this2.mergeResponse(res.data);
      });
    },
    updateParent: function updateParent(node, newParent) {
      var _this3 = this;

      var oldParent = node.parentId && this.parents[node.parentId];
      ...
      return this.updateNode(node, {
        ...
        if (oldParent) {
          ...
          _this3.order(oldParent.children);
        }
      });
    },
    fetchData: function fetchData() {
      ...
      this.loading = true;
      Nova.request().get("/nova-api/" + this.resource).then(function (res) {
        _this4.currentNode = null;
        // console.log('res.data', res.data)
        _this4.parseResources(res.data.resources);
        _this4.updateRetrievedAt();
      }).catch(function (err) {
        // console.error(err)
        _this4.$router.replace("/404");
      }).then(function () {
        return _this4.loading = false;
      });
    },
    setIconState: function setIconState() {
      var _this5 = this;

      var children = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      var parentActive = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;

      Array.isArray(children) && children.forEach(function (child) {
        child.icon = _this5.isActiveIcon(child.is_active, parentActive);
        _this5.setIconState(child.children, child.icon === "enabled");
      });
    },
    isActiveIcon: function isActiveIcon(active, parentActive) {
      return !active ? "disabled" : parentActive ? "enabled" : "parentDisabled";
    },
    order: function order(nodes) {
      nodes.sort(function (a, b) {
        return a.order > b.order ? 1 : -1;
      });
    },
    updateRetrievedAt: function updateRetrievedAt() {
      this.lastRetrievedAt = Math.floor(Date.now() / 1000);
    },
    deleteNode: function deleteNode() {
      var _this6 = this;

      Nova.request().delete("/nova-api/" + this.resource + "?resources[]=" + this.currentNode.id).then(function (res) {
        var parent = _this6.parents[_this6.currentNode.parentId];
        if (parent) {
          parent.children.splice(parent.children.indexOf(_this6.currentNode), 1);
        } else {
          ...
          try {
            for (var _iterator = Object.entries(_this6.tree)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              ...
              if (value.id === _this6.currentNode.id) {
                __WEBPACK_IMPORTED_MODULE_2_vue___default.a.delete(_this6.tree, key);
              }
            }
          } catch (err) {
        ...
        _this6.currentNode = null;
        _this6.$toasted.show("The skill is deleted!", { type: "success" });
      }).catch(function (err) {
        console.error("err");
        console.error(err);
    ...
    toggleNode: function toggleNode() {
      ...
      var activeState = node.is_active;
      ...
      this.updateNode(node, {
        ...
        // console.error(err)
        node.is_active = activeState;
        _this7.$toasted.show("Failed toggling resource!", { type: "error" });
      });
    },
    ...
    mergeResponse: function mergeResponse(res) {
      if (res.id && res.resource) {
        ...
        if (res.parent_id === undefined) {
          ...
          var _res$resource = res.resource,
              id = _res$resource.id,
          ...
          var node = this.tree.find(function (tr) {
            return tr.id == id;
          });
          ...
          console.log("res.resource", res.resource);
          var _res$resource2 = res.resource,
          ...
          _node.parentText = parent ? parent.name : null;
          _node.parentId = _parent_id;
          _node.text = _name;
          _node.is_active = _is_active;
          _node.icon = parent ? this.isActiveIcon(_is_active, parent.icon === "enabled") : null;
  ...
  components: {
    ...
    TreeDetails: __WEBPACK_IMPORTED_MODULE_0__TreeDetails___default.a
  }
});
...
Component.options.__file = "resources/js/components/TreeDetails.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-43d661a9", Component.options)
  } else {
    hotAPI.reload("data-v-43d661a9", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
    ...
    methods: {
        confirmDelete: function confirmDelete() {
            ...
            if (this.node.children.length != 0) {
                ...
                this.$toasted.show("Sorry, Can't delete resource if there are sub resources. Please delete sub resources first.", { type: 'error' });
            } else {
            ...
            _c(
              ...
              [
                _vm._v(
                  "Details - " +
                    _vm._s(
                      _vm.node.text.length < 14
                        ? _vm.node.text
                        : _vm.node.text.substring(0, 13) + ".."
                    )
                )
              ]
            ),
            ...
            _c(
              ...
              [
                _c(
                  "button",
                  {
                    staticClass: "btn btn-default btn-icon btn-white mr-3",
                    attrs: { title: "Delete" },
                    on: {
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "w-1/4 py-4" }, [
      _c("h4", { staticClass: "font-normal text-80" }, [_vm._v("Order")])
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "w-1/4 py-4" }, [
      _c("h4", { staticClass: "font-normal text-80" }, [_vm._v("Score")])
    ])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-43d661a9", module.exports)
  }
}
    ...
    _c(
      ...
      [
        _c("v-jstree", {
          ...
          on: { "item-drop": _vm.dragEnded, "item-click": _vm.itemClick }
        }),
        _vm._v(" "),
        _vm.currentNode
          ? _c("TreeDetails", {
              attrs: { resource: _vm.resource, node: _vm.currentNode },
              on: {
                onOrder: _vm.orderNode,
                onDelete: _vm.deleteNode,
                onToggle: _vm.toggleNode
              }
            })
          : _vm._e()
      ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-138228ee", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "h1",
        { staticClass: "mb-3 text-90 font-normal text-2xl capitalize" },
                ...
                "router-link",
                {
                  ...
                  attrs: {
                    to:
                      "/resources/" +
                      _vm.resource +
                      "/new?viaResource=&viaResourceId=&viaRelationship=",
                    dusk: "create-button"
                  }
                },
                [
                  _vm._v(
                    "\n          Create " + _vm._s(_vm.resource) + "\n        "
                  )
                ]
              )
            ],
      ...
      _vm._v(" "),
      _c("Tree", { attrs: { resource: _vm.resource } })
    ],
    1
  )
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-25854ca8", module.exports)
  }
}
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("TreeContainer", { attrs: { resource: _vm.$route.query.resource } })
}
var staticRenderFns = []
render._withStripped = true
module.exports = { render: render, staticRenderFns: staticRenderFns }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(25), __webpack_require__(28).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(25), __webpack_require__(30)))
